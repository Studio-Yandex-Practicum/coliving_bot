...
roommate_search_handler: ConversationHandler = ConversationHandler(
    ...
    states={
        ...
        states.LOCATION: [
            CallbackQueryHandler(callback=callbacks.set_location,
        ...
        states.NEXT_PROFILE: [
            CallbackQueryHandler(callback=callbacks.next_profile,
                                 pattern=rf"^{buttons.YES_BTN}$"),
            CallbackQueryHandler(callback=callbacks.end_of_search,
        ...
        states.NO_MATCHES: [
            ...
            CallbackQueryHandler(callback=callbacks.edit_settings,
        ...
        states.PROFILE: [
            CallbackQueryHandler(callback=callbacks.profile_like,
        ...
        states.SEARCH_SETTINGS: [
            CallbackQueryHandler(callback=callbacks.ok_settings,
