...
PROFILE_LIKE_TEXT = (
    "Отлично вы поставили <b>«лайк 👍»</b>,"
    " пользователь получил уведомление об этом,"
    " ожидайте мэтча и продолжайте поиск!"
)
NO_MATCHES = (
...
MAXIMUM_AGE_ERROR_MESSAGE = "Максимальный возраст не может быть меньше минимального."
