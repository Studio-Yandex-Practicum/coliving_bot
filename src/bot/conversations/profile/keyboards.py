...
PROFILE_KEYBOARD = InlineKeyboardMarkup.from_column(
    button_column=(
        InlineKeyboardButton(
            text=SHOW_SEARCH_BUTTON, callback_data=SHOW_SEARCH_BUTTON
        ),
        InlineKeyboardButton(
            text=HIDE_SEARCH_BUTTON, callback_data=HIDE_SEARCH_BUTTON
        ),
        InlineKeyboardButton(
            text=EDIT_FORM_BUTTON, callback_data=EDIT_FORM_BUTTON
        ),
...
FORM_VISIBLE_KEYBOARD = InlineKeyboardMarkup.from_column(
    button_column=(
        InlineKeyboardButton(
            text=YES_TO_DO_BUTTON, callback_data=YES_TO_DO_BUTTON
        ),
        InlineKeyboardButton(
            text=NOT_LOOK_YET_BUTTON, callback_data=NOT_LOOK_YET_BUTTON
        ),
    )
)
...
FORM_EDIT_KEYBOARD = InlineKeyboardMarkup.from_column(
    button_column=(
        InlineKeyboardButton(
            text=FILL_AGAIN_BUTTON, callback_data=FILL_AGAIN_BUTTON
        ),
        InlineKeyboardButton(text=ABOUT_BUTTON, callback_data=ABOUT_BUTTON),
        InlineKeyboardButton(
            text=NEW_PHOTO_BUTTON, callback_data=NEW_PHOTO_BUTTON
        ),
    )
)
...
FORM_SAVE_OR_EDIT_KEYBOARD = InlineKeyboardMarkup.from_column(
    button_column=(
        InlineKeyboardButton(text=YES_BUTTON, callback_data=YES_BUTTON),
        InlineKeyboardButton(
            text=EDIT_CANCEL_BUTTON, callback_data=EDIT_CANCEL_BUTTON
        ),
        InlineKeyboardButton(
            text=EDIT_RESUME_BUTTON, callback_data=EDIT_RESUME_BUTTON
        ),
    )
)
